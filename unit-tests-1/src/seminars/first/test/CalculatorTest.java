...
public class CalculatorTest {
    public static void main(String[] args) {
        assertThat(Calculator.calculateDiscount(100, 6)).isEqualTo(94);
        assertThatThrownBy(() -> Calculator.calculateDiscount(-100, 4)).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy(() -> Calculator.calculateDiscount(100, -4)).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy(() -> Calculator.calculateDiscount(100, 400)).isInstanceOf(ArithmeticException.class);
